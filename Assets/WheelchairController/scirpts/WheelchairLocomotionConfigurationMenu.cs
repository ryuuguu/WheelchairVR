...
namespace WheelchairController
{
    ...
    public class WheelchairLocomotionConfigurationMenu : MonoBehaviour
    {
...
/*
        ...
        bool ValidateManager()
        {
            if (m_Manager == null)
            {
                Debug.LogError($"Reference to the LocomotionSchemeManager is not set or the object has been destroyed," +
            ...
            {
                Debug.LogError($"Reference to the ContinuousMoveProviderBase is not set or the object has been destroyed," +
                    " configuring locomotion settings from the menu will not be possible." +
            ...
            {
                Debug.LogError($"Reference to the ContinuousTurnProviderBase is not set or the object has been destroyed," +
                    " configuring locomotion settings from the menu will not be possible." +
                    " Ensure the value has been set in the Inspector on {m_Manager}.", this);
                return false;
            }
            ...
            {
                Debug.LogError($"Reference to the SnapTurnProviderBaseis not set or the object has been destroyed," +
                    " configuring locomotion settings from the menu will not be possible." +
                    " Ensure the value has been set in the Inspector on {m_Manager}.", this);
                return false;
            }
