...
namespace WheelchairController
{
    /// <summary>
    ...
    /// </example>
    /// </remarks>
    public class WheelchairLocomotionSchemeManager : MonoBehaviour
    {
        /// <summary>
        ...
        public UnityEngine.XR.Interaction.Toolkit.ContinuousTurnProviderBase continuousTurnProvider
        {
        ...
        UnityEngine.XR.Interaction.Toolkit.SnapTurnProviderBase m_SnapTurnProvider;
        /// <summary>
        /// Stores the locomotion provider for snap turning.
        /// </summary>
        /// <seealso cref="SnapTurnProviderBase"/>
        public UnityEngine.XR.Interaction.Toolkit.SnapTurnProviderBase snapTurnProvider
        {
        ...
        [SerializeField]
        [Tooltip("Stores the \"Rig\" Transform used with continuous movement when inputs should be relative to the rig orientation.")]
        Transform m_RigForwardSource;
        /// <summary>
        /// Stores the "Rig" <see cref="Transform"/> used with continuous movement when inputs should be relative to the rig orientation.
        /// </summary>
        public Transform rigForwardSource
        {
            get => m_RigForwardSource;
            set => m_RigForwardSource = value;
        }
        ...
        void SetMoveForwardSource(MoveForwardSource forwardSource)
        {
            if (m_ContinuousMoveProvider == null)
            {
                Debug.LogError($"Cannot set forward source to {forwardSource}," +
                    $" the reference to the {nameof(UnityEngine.XR.Interaction.Toolkit.ContinuousMoveProviderBase)} is missing or the object has been destroyed.", this);
                return;
            }
            ...
            switch (forwardSource)
            {
                ...
                case MoveForwardSource.RightHand:
                    ...
                    break;
                case MoveForwardSource.Rig:
                    m_ContinuousMoveProvider.forwardSource = m_RigForwardSource;
                    break;
                default:
